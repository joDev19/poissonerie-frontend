<template>
    <VueFinalModal class="flex justify-center items-center p-5"
        ...
        <h1>Confirmation !</h1>
        <p>êtes vous sur de vouloir supprimer cette marque: {{ marque.name }} ? </p>
        <div class="flex justify-center">
            <div class="flex gap-3 w-full">
                ...
                <div class="w-1/2">
                    <Button type-name="button" text="Confirmer" :loading="false" @click="() => { crudStore.delete(marque.id);  emit('confirm')}" />
